                ...
                <div class="card-body">
                    <form action=" {{ route('admin#updatePost',$updatePost['post_id']) }} " method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="postName" value="{{ old('postName', $updatePost['title']) }}"
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="postDescription" placeholder="Enter Post Deacription..." id="" cols="30" rows="10"
                                class="form-control @error('postDescription') is-invalid  @enderror">{{ old('postDescription', $updatePost['description']) }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <img @if ($updatePost['image'] == null) src="{{ asset('Default/defaultImage.jpg') }} "
                            @else src="{{ asset('postImage/' . $updatePost['image']) }} " @endif
                                width="100%" class="rounded img-thumbnail" alt="">
                            ...
                            <select name="postCategory" class="form-control @error('postCategory') is-invalid  @enderror">
                                ...
                                @foreach ($category as $c)
                                    <option value="{{ $c['category_id'] }} "
                                        @if ($c['category_id'] == $updatePost['category_id']) selected @endif> {{ $c['title'] }} </option>
                                @endforeach
                            </select>
                            @error('postCategory')
                                <div class="text-danger invalid-feedback">
